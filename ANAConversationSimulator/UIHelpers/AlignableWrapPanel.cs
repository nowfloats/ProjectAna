...
namespace ANAConversationSimulator.UIHelpers
{
    public class AlignableWrapPanel : Panel
    {
        ...
        public static readonly DependencyProperty ItemWidthProperty = DependencyProperty.Register("ItemWidth", typeof(double),
                typeof(AlignableWrapPanel), new PropertyMetadata(double.NaN, (s, e) => { (s as AlignableWrapPanel).InvalidateArrange(); }));
        ...
        public static readonly DependencyProperty OrientationProperty = DependencyProperty.Register("Orientation", typeof(Orientation), typeof(AlignableWrapPanel),
        ...
        public static readonly DependencyProperty HorizontalContentAlignmentProperty = DependencyProperty.Register(nameof(HorizontalContentAlignment), typeof(HorizontalAlignment),
                typeof(AlignableWrapPanel), new PropertyMetadata(HorizontalAlignment.Left, (s, e) => { (s as AlignableWrapPanel).InvalidateArrange(); }));
        ...
        public static readonly DependencyProperty VerticalContentAlignmentProperty = DependencyProperty.Register(nameof(VerticalContentAlignment), typeof(VerticalAlignment),
                typeof(AlignableWrapPanel), new PropertyMetadata(VerticalAlignment.Top, (s, e) => { (s as AlignableWrapPanel).InvalidateArrange(); }));
