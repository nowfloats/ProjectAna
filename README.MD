...
*World's first **Open Source Conversation Platform** which comes with a **Graphical Chat Flow Designer** and **Chat Simulator**. Once setup is completed, chat flow can be fully controlled by non-devs.*
