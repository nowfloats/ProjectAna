...
namespace ANAConversationStudio.Models.Chat
{
    ...
    public class ChatNode : INotifyPropertyChanged
    {
        ...
        [NewItemTypes(typeof(TextSection), typeof(GifSection), typeof(ImageSection), typeof(GraphSection), typeof(EmbeddedHtmlSection), typeof(AudioSection), typeof(VideoSection), typeof(CarouselSection), typeof(PrintOTPSection))]
        [Category("Important")]
        [PropertyOrder(3)]
